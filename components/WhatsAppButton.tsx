...
import { whatsappNumber, companyInfo } from "@/data/content";
...
export default function WhatsAppButton() {
  ...
  const handleClick = () => {
    const message = encodeURIComponent(
      `Hello! I'm interested in ${companyInfo.name} services. Please provide more information.`
    );
    ...
    <div className="fixed bottom-6 right-6 z-50">
      ...
      {showTooltip && (
        <div className="absolute bottom-full right-0 mb-3 animate-bounce-in">
          <div className="bg-white rounded-lg shadow-xl p-4 max-w-[250px] relative">
            <button
