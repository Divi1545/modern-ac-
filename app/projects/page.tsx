          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed mb-8">
                From initial assessment and system design to installation,
                testing, and commissioning, every project is managed with
                meticulous attention to detail.
              </p>

              <div className="space-y-4">
                {[
                  "Automotive AC systems for all vehicle types",
                  "Residential cooling with Misty products",
                  "Commercial HVAC for offices and retail",
                  "Industrial refrigeration and cold rooms",
                  "Marine air conditioning systems",
                  "Healthcare facility HVAC solutions",
                ].map((item, idx) => (
            ...
            >
              <div className="space-y-4">
                <div className="relative h-48 rounded-xl overflow-hidden">
                  <Image
                    src="/images/projects/project-work-1.jpg"
                    alt="Project Work"
                    fill
                    className="object-cover"
                  />
                ...
                <div className="relative h-64 rounded-xl overflow-hidden">
                  <Image
                    src="/images/projects/project-work-2.jpg"
                    alt="Project Work"
                    fill
                    className="object-cover"
                  />
              ...
              <div className="space-y-4 pt-8">
                <div className="relative h-64 rounded-xl overflow-hidden">
                  <Image
                    src="/images/projects/project-work-3.jpg"
                    alt="Project Work"
                    fill
                    className="object-cover"
                  />
                ...
                <div className="relative h-48 rounded-xl overflow-hidden">
                  <Image
                    src="/images/projects/project-work-4.jpg"
                    alt="Project Work"
                    fill
                    className="object-cover"
                  />
